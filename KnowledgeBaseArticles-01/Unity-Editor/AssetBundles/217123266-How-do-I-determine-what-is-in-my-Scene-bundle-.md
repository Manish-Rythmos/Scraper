...
This will extract the data to a folder called whatever your Scene bundle name is with \_data appended (for example  **YourSceneBundleName\_data** ).



**3.**  Run binary2text:
*binary2text YourSceneBundleName\_data/BuildPlayer-SceneBundleName"*
